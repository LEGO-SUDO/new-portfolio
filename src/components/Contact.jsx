  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_EMAILJS_TEMPLATE, // paste your TemplateID here (you'll find it under email templates).
        {
          from_name: form.name,
          to_name: "Nakul", // put your name here.
          from_email: form.email,
          to_email: "signhnakul196@gmail.com", //put your email here.
