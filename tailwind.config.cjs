  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        smcardLight: '0px 9px 28px #eaeaec, 0px 5px 3px #eaeaec',
      },
      screens: {
        xs: '450px',
        sm: '640px',
      ...
      backgroundImage: {
        ...
        tech: "linear-gradient(165deg, rgba(20,20,20,0.8) 100%, rgba(109,109,116,0.8) 100%), url('/src/assets/backgrounds/nairobi.webp')",
      },
      fontFamily: {
        arenq: ['Arenq'],
        beckman: ['Beckman'],
